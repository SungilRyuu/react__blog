          ...
          <div class="blog__layout">
            <div class="blog__left">
              ...
              <p>
                ...
                placeat veritatis alias vitae. Harum, illum quisquam! Harum animi quidem nesciunt debitis rerum
                provident laborum eligendi distinctio quos omnis, corrupti eos.
                <br />
                <br />
                ...
                내용을 활용하는 과정에 따라 적절한 보상을 하면서 처음부터 걷고 뛰는 방법을 익히도록 한다. 다소 오랜
                시간이 걸릴 수 있지만, 시간이 지나면서 가상 환경을 경험하면서 높은 적응 능력을 갖추도록 지원할 수
                있었다.
                <br />
                <br />
